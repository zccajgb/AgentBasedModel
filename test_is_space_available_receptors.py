...
class Test_is_space_available_receptors(unittest.TestCase):
    ...
    #     self.assertFalse(master.is_space_available_nanoparticle(position))
    ...
    #     self.assertTrue(master.is_space_available_nanoparticle(position))
